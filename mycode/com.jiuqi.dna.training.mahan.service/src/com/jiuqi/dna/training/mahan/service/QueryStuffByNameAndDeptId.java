...
public final class QueryStuffByNameAndDeptId extends QueryStatementDeclarator {
		...
		public QueryStuffByNameAndDeptId() {
			this.arg_name = this.query.getArguments().get(0);
			this.arg_deptid = this.query.getArguments().get(1);
